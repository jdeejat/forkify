...
//import { Fraction } from 'fractional'; is not used anymrore
import { numberToFraction } from '../helpers';

class RecipeView extends View {
  _parentElement = document.querySelector('.recipe');
  _errorMessage = 'We could not find it. Please try another.';
  _message = 'Success';

  addHandlerRender(handler) {
    // add event listener to multiple events hashchange and load
